...
public class JobManageViewController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void handleAddJobButton(ActionEvent actionEvent) throws IOException {
        HelperClass.sceneSwitch(actionEvent, "post-job-form.fxml", "Post Job");
    }

    @javafx.fxml.FXML
    public void handleBackJobButton(ActionEvent actionEvent) throws IOException {
        HelperClass.sceneSwitch(actionEvent, "rec-dash-view.fxml", "Post Job");
    }
}